...
import { ModeTestnet } from '@particle-network/chains';
...
const App = () => {
  ...
  const smartAccount = new SmartAccount(provider, {
    ...
    aaOptions: {
      accountContracts: {
        SIMPLE: [{ chainIds: [ModeTestnet.id], version: '1.0.0' }],
      }
    }
  });
  ...
  return (
    <div className="App">
      <div className="logo-section">
        ...
        <img src="https://i.imgur.com/ozmNWdO.png" alt="Logo 2" className="logo" />
      </div>
      {!userInfo ? (
